...
{ if($this -> myde_page != 1){  
    return "    <li class=\"paginItem\"><a href=\"".$this -> page_replace(1)."\" title=\"first\" class=\"firstpage\">first</a></li>\n";   
   }else{  
...
{
   if($this -> myde_page != $this -> myde_page_count){  
     return "    <li class=\"paginItem \"><a href=\"".$this -> page_replace($this -> myde_page_count)."\" title=\"last\" class=\"lastpage\">last</a></li>\n";
    
   }else{  
    return "    <li class=\"paginItem\"><a href=\"javascript:void(0)\" class=\"lastpage\">last</a></li>\n";   
   }
} 
function myde_write($showAll=true,$showCur=true,$showIpt=true,$prevBtnText='&lt;',$nextBtnText='&gt;',$id='pagin') //输出
{
   ...
   for($page_for_i=$this->page_i;$page_for_i <= $this -> page_ub; $page_for_i++){  
    if($this -> myde_page == $page_for_i){   
     ...
     $str .= "    <li class=\"paginItem \"><a href=\"".$this -> page_replace($page_for_i)."\" title=\"第".$page_for_i."页\">";    
     $str .= $page_for_i . "</a></li>\n";    
    }
        }
