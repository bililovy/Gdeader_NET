...
INSERT INTO `ft_adminuser` VALUES (1,'bililovy','思阳','bililovy@163.com','1d6b0268d4733d4dc22dc8bcb29d67c4',1447726000,2,1439719314,0);
...
CREATE TABLE `ft_attribute` (
  ...
  `catid` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT '商品类型，同ecs_goods_type的cat_id',
  ...
  `sortorder` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '属性显示的顺序，数字越大越靠前，如果数字一样则按id顺序',
  PRIMARY KEY (`id`),
  KEY `catid` (`catid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2015-11-18 18:19:34
